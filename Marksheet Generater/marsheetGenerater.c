...
int roll_number, class; 
int hi_marks, eng_marks, san_marks, math_marks, sci_marks, so_sci_marks;
int grand_total;
//int grand_total = (hi_marks + eng_marks + san_marks + math_marks + sci_marks + so_sci_marks);
...
repeate:  //IT ALLOW YOU TO REAPPLY THE PREVIOUS APPLIED EFFECT OR CORRECTION WITHOUT HAVING TO RE-ACCESS THE CORRESPONDING DIALOG BOX
    printf("Hindi marks: ");
    scanf("%d", &hi_marks);
    if (hi_marks > 100 || hi_marks < 0 )
    {
...
repeate5:
    ...
    if (so_sci_marks > 100 || so_sci_marks < 0)
    {
        printf("invalid marks enter valid marks\n");
        goto repeate5;
    }
...
void generate_marksheet()
{
    ...
    printf("|------------------------------------------------------------------------------------\n");
    printf("|\tHINDI         \t  100      \t   30       \t    %d\n", hi_marks);
    printf("|\tENGLISH       \t  100      \t   30       \t    %d\n", eng_marks);
    printf("|\tSANSKRIT      \t  100      \t   30       \t    %d\n", san_marks);
    printf("|\tMATHEMATICs   \t  100      \t   30       \t    %d\n", math_marks);
    printf("|\tSCIENCE       \t  100      \t   30       \t    %d\n", sci_marks);
    printf("|\tSOCIAL SCIENCE\t  100      \t   30       \t    %d\n", so_sci_marks);
    printf("|------------------------------------------------------------------------------------\n");
    printf("|\t              \t              GRAND TOTAL\t    %d\n", grand_total);
    printf("|------------------------------------------------------------------------------------\n");
    if (hi_marks < 30 || eng_marks < 30 || san_marks < 30 ||math_marks < 30 || sci_marks < 30 || so_sci_marks < 30)
    {
        printf("|RESULT : FAIL\n");
        printf("|GRADE  : F\n");
    }
    else if (hi_marks >= 30 && eng_marks >= 30 && san_marks >= 30 && math_marks >= 30 && sci_marks >= 30 && so_sci_marks >= 30)
    {
        ...
        else if (presentage >= 60 && presentage < 81)
        {
            printf("|RESULT : 1ST DIVISION\n");
            printf("|GRADE  : A\n");
        }
        else if (presentage >= 45 && presentage < 60)
        {
            printf("|RESULT : 2ND DIVISION\n");
            printf("|GRADE  : B\n");
        }
        else if (presentage >= 30 && presentage < 45)
        {
            printf("|RESULT : 3RD DIVISION\n");
            printf("|GRADE  : P\n");
        }
        else if (presentage >= 0 && presentage < 30)
        {
            printf("|RESULT : FAIL\n");
            printf("|GRADE  : F\n");
        }
...
{
    char yesNo,Results;
    printf("\n             *Welcome to marsheet generation System*               \n\n");
    printf("If you want to generate your marsheet then you have to provide some information\n");
